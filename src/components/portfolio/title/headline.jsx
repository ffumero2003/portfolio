...
export default function Headline() {
  return (
    <>
      <div
        className="relative w-full md:w-1/2 overflow-hidden rounded-3xl border p-7 mt-5"
        style={{
      ...
      >
        ...
        <div className="mt-6  w-fit">
          <a href="#projects">
            <ButtonPrimary text="See Projects" />
          </a>
        </div>
      </div>
      ...
      <div className="w-11/12 md:w-3/6">
        <div
          className="aspect-[1/1] rounded-3xl  pointer-events-none -z-10"
          aria-hidden="true"
        >
          <Suspense
            fallback={
              <div className="w-full h-full animate-pulse rounded-3xl" />
            }
          >
            <TitleSection />
          </Suspense>
