...
const TIMELINE = [
  { title: "Currently", date: "NOW 2025", desc: "Studying Business Administration at Lead University (grad. Jan 2026) while managing projects and preparing for first dev job." },
  { title: "Took Action", date: "MAY 2025", desc: "Sought guidance at Cenfotec after realizing my projects weren’t strong enough." },
  { title: "Decision", date: "JAN 2025", desc: "Committed seriously, revisited front-end courses, and moved beyond basics." },
  { title: "University Technician", date: "AUG 2024", desc: "Graduated from CENFOTEC and deepened interest in web development." },
  { title: "Cenfotec University", date: "OCT 2023", desc: "Pursued Software Development Technician degree but didn’t go deep enough." },
  { title: "Graduation", date: "JUN 2022", desc: "Finished Business Admin basics while exploring software development direction." },
];
                  ...
                  >
                    <div className="relative group/card transform-gpu">
                      ...
                      >
                        ...
                        >
                          <p className="text-[10px] md:text-xs tracking-wide uppercase" style={{ color: "var(--color-primary)" }}>
                            {step.date}
                          </p>
                        </div>

                        <h3 className="mt-1.5 md:mt-2 text-sm md:text-lg font-bold" style={{ color: "var(--color-primary)" }}>
                          {step.title}
                        </h3>

                        <p className="mt-1 text-[13px] leading-relaxed md:text-[15px]" style={{ color: "var(--color-text)" }}>
                          {step.desc}
                        </p>
                      </div>
                    </div>
